...
#---------------
#Spoofing dataset
#This creates log file for vehicle 4 (candump-09-13-2021_vehicle_4.log)
#---------------
...
#paper indicates 5 seconds of spoofing and 5 seconds of normal
#5 seconds = 7280 messages
# ID 025, handle angle , 12 ms interval
# ID 0B4, speed, 25 ms interval


#For our car, 13C is speed (throttle) as well as 17C
#link:
#https://forums.raspberrypi.com/viewtopic.php?t=220138


#25 ms = 0.025 seconds = 44 messages
for i in range(7280):  #5 sec of attack
    # if 25 ms of attack has passed (44 messages):
    if i % 44 == 0 and i % 88 != 0:  #if i = 44, 132, ...
            for j in range(44):  #j spans 25 ms
                can_ids[1000 + i - j] = "000"   #first 1000 message must pass first

"""    
    # if 25 ms of normal has passed
    elif i % 88 == 0    #if i = 88, 176, ...
            for j in range(44):
                can_ids[1000 + i - j] = can_ids[1000 + i - j]
"""                

#2.5 sec of attack = 7280 / 2 = 3640 attack messages so far
...
for i in range(7280):  #5 sec of attack
    ...
    if i % 44 == 0 and i % 88 != 0:  #if i = 44, 132, ...
            for j in range(44):  #j spans 25 ms
                can_ids[100000 + i - j] = "000"   #first 100000 message must pass first

"""    
    # if 25 ms of normal has passed
    elif i % 88 == 0    #if i = 88, 176, ...
            for j in range(44):
                can_ids[100000 + i - j] = can_ids[100000 + i - j]
"""                

#Total attack time = 5 seconds = 7280 messages
...
for i in range(7280):  #5 sec of attack
    ...
    if i % 44 == 0 and i % 88 != 0:  #if i = 44, 132, ...
            for j in range(44):  #j spans 25 ms
                can_ids[200000 + i - j] = "000"   #first 200000 message must pass first

"""    
    # if 25 ms of normal has passed
    elif i % 88 == 0    #if i = 88, 176, ...
            for j in range(44):
                can_ids[200000 + i - j] = can_ids[200000 + i - j]
"""                

#Total attack time = 7.5 seconds = 7280 + 3640 = 10920 messages
...
for i in range(7280):  #5 sec of attack
    ...
    if i % 44 == 0 and i % 88 != 0:  #if i = 44, 132, ...
            for j in range(44):  #j spans 25 ms
                can_ids[300000 + i - j] = "000"   #first 300000 message must pass first

"""    
    # if 25 ms of normal has passed
    elif i % 88 == 0    #if i = 88, 176, ...
            for j in range(44):
                can_ids[300000 + i - j] = can_ids[300000 + i - j]
"""                

#Total attack time = 10 seconds = 14560 messages
...
for i in range(7280):  #5 sec of attack
    ...
    if i % 44 == 0 and i % 88 != 0:  #if i = 44, 132, ...
            for j in range(44):  #j spans 25 ms
                can_ids[600000 + i - j] = "000"   #first 600000 message must pass first

"""    
    # if 25 ms of normal has passed
    elif i % 88 == 0    #if i = 88, 176, ...
            for j in range(44):
                can_ids[600000 + i - j] = can_ids[600000 + i - j]
"""                

#Total attack time = 12.5 seconds = 18200 messages
...
with open("candump-09-13-2021_vehicle_4.log", 'w') as newfile:    
    for i in range(860684):
