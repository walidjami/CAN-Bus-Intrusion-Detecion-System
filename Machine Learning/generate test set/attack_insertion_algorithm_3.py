...
#---------------
#DoS dataset
#This creates log file for vehicle 3 (candump-09-13-2021_vehicle_3.log)
#---------------
...
#dos attack typically starts from 20 seconds for a 10-second period and the interval time is 0.5 ms and the 
#attack duration is 5 seconds (dos 0.5 ms, normal 0.5 ms, dos 0.5 ms, ... until 5 seconds has passed, 
#then 5 seconds of normal)


for i in range(7280):  #5 sec of attack
    # if 0.5 ms of attack has passed (2 messages):
    if i % 2 == 0 and i % 4 != 0:  #if i = 2, 6, ...
            for j in range(2):  #j spans 0.5 ms
                can_ids[1000 + i - j] = "000"   #first 1000 message must pass first

"""    
    # if 0.5 ms of normal has passed
    elif i % 4 == 0    #if i = 4, 8, ...
            for j in range(2):
...
for i in range(7280):  #5 sec of attack
    ...
    if i % 2 == 0 and i % 4 != 0:  #if i = 2, 6, ...
            for j in range(2):  #j spans 0.5 ms
                can_ids[400000 + i - j] = "000"   #first 400000 message must pass first

"""    
    # if 0.5 ms of normal has passed
    elif i % 4 == 0    #if i = 4, 8, ...
            for j in range(4):
                can_ids[400000 + i - j] = can_ids[400000 + i - j]
"""                
...
for i in range(7280):  #5 sec of attack
    ...
    if i % 2 == 0 and i % 4 != 0:  #if i = 2, 6, ...
            for j in range(2):  #j spans 0.5 ms
                can_ids[500000 + i - j] = "000"   #first 500000 message must pass first

"""    
    # if 0.5 ms of normal has passed
    elif i % 4 == 0    #if i = 4, 8, ...
            for j in range(4):
                can_ids[500000 + i - j] = can_ids[500000 + i - j]
"""                
...
with open("candump-09-13-2021_vehicle_3.log", 'w') as newfile:    
    for i in range(860684):
