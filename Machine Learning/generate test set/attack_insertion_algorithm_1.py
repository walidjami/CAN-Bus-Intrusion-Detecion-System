...
#This creates log file for vehicle 1 (candump-09-13-2021_vehicle_1.log)
...
print(original_log[0][:19])  #time stamp
print(original_log[0][25:28])  #id
print(original_log[0][29:31])  #p1
print(original_log[0][31:33])  #p2
print(original_log[0][33:35])  #p3
print(original_log[0][35:37])  #...
print(original_log[0][37:39])
print(original_log[0][39:41])
print(original_log[0][41:43])
print(original_log[0][43:45])

#print(type(original_log))  #list
...
print(can_messages_p3[773823])
print(can_messages_p3[773823 - 1])


print(type(can_messages_p1))
...
with open("candump-09-13-2021_vehicle_1.log", 'w') as newfile:    
    for i in range(860684):
